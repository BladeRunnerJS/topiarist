...
;(function(definition) {
	...
	// These shams only cover the cases used within topiarist. When IE8 support is no longer needed, all these can be 
	//  dropped in favour of the es5 methods.
	...
	var methods = {
		'extend': extend, 'inherit': inherit, 'mixin': mixin, 'hasImplemented': hasImplemented,
