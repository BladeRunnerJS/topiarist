...
(function() {
	 ...
	 * will return the correct thing, and provides a 'superclass' property.</p>
	 *
	...
	function fallbackIsAssignableFrom(classdef, parent) {
		...
		// parent
		var superPrototype = classdef.prototype.superclass || Object.getPrototypeOf(classdef.prototype);
		if (superPrototype != null && superPrototype !== classdef.prototype && isAssignableFrom(superPrototype.constructor, parent)) {
			return true;
		}
	...
	function attributesFromParents(classdef) {
		...
		var parentProto = classdef.prototype.superclass || Object.getPrototypeOf(classdef.prototype);
