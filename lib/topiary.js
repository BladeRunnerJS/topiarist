...
;(function (definition) {
	...
	function fallbackIsAssignableFrom(classDefinition, parent) {
		...
		// parent
		var superPrototype = (classDefinition.superClass && classDefinition.superClass.prototype) || Object.getPrototypeOf(classDefinition.prototype);
	...
	function getImmediateParents(sub) {
		...
		var parentPrototype = (sub.superClass && sub.superClass.prototype) || Object.getPrototypeOf(sub.prototype);
